...
const foreignWords = [
    new ForeignWord('Movie', 'Фильм', 'Did you see that movie, Joe?'),
    new ForeignWord('Actor', 'Актер', 'The dramatic actor, good!'),
    new ForeignWord('Fantasy', 'Фантастика', 'I have no interest your fantasy'),
    new ForeignWord('Animation', 'Анимация', 'I think the animation first in nicely'),
    new ForeignWord('Subtitles', 'Субтитры', 'I tould you there would be subtitles'),
    new ForeignWord('Episode', 'Эпизод', 'Unfortunately, this is the last episode')
]
